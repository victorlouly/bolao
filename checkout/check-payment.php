...
// NOTA: A atualização da UTMify é feita automaticamente pelo webhook.php
// quando a bynet envia a notificação de pagamento. Este arquivo apenas
...
if ($httpCode === 200 && isset($responseData['data'])) {
    ...
    // NOTA: A atualização da UTMify é feita automaticamente pelo webhook.php
    // quando a bynet envia a notificação de pagamento. Não precisamos atualizar aqui
